...
public class BottomSheetNavigationFragment extends BottomSheetDialogFragment {
    ...
    public static BottomSheetNavigationFragment newInstance(String name,String phone,String gender,String email,String imagePath) {
    ...
    public void setupDialog(final Dialog dialog, int style) {
        ...
        name=contentView.findViewById(R.id.us_name);
        email = contentView.findViewById(R.id.us_email);
        phone = contentView.findViewById(R.id.us_phone);
        gender=contentView.findViewById(R.id.us_gender);
